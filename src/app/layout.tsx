...
export const metadata: Metadata = {
  title: "DentalCare Plus - Expert Dental Care & Modern Dentistry",
  description: "Experience exceptional dental care with state-of-the-art technology. Comprehensive services including general dentistry, cosmetics, orthodontics & emergency care.",
  keywords: "dental care, dentist, teeth cleaning, cosmetic dentistry, orthodontics, dental clinic, oral health, emergency dentist",
  metadataBase: new URL("https://dentalcareplus.com"),
  alternates: {
    canonical: "https://dentalcareplus.com"
  },
  openGraph: {
    title: "DentalCare Plus - Expert Dental Care & Modern Dentistry",
    description: "Experience exceptional dental care with state-of-the-art technology and compassionate professionals.",
    siteName: "DentalCare Plus",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763394960540-9qjedf8g.jpg",
  ...
  twitter: {
    ...
    title: "DentalCare Plus - Expert Dental Care",
    description: "Experience exceptional dental care with state-of-the-art technology and compassionate professionals.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763394960540-9qjedf8g.jpg"]
  },
  robots: {
    index: true,
    follow: true
